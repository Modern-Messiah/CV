  ...
  ru: {
    ...
    experiences: [
      ...
      },
      {
        ...
        description:
          "Разработал интернет-магазин на Laravel с использованием паттернов Repository, Service Layer. Реализовал каталог товаров с системой фильтрации и поиском. Интегрировал платежные системы и способы доставки. Создал личный кабинет пользователя и административную панель. Разработал систему управления заказами, скидок и промокодов. Настроил email-уведомления о статусе заказов. Реализовал систему авторизации и регистрации пользователей.",
      ...
      },
      {
        ...
        description:
          "Разработал системы автоматизации для книжного магазина на базе 1С:Предприятие 8.3 Реализовал полный цикл проведения продаж: оформление заказов, работа с клиентами, формирование документов. Разработал систему отчетов для анализа продаж, остатков, прибыльности. Создал ролевую модель доступа с разграничением прав (продавец, кассир, менеджер, администратор). Настроил учет товаров на складе с контролем остатков. Автоматизировал формирование первичных документов (накладные, акты, счета). Результат: убрали ручной учет в Excel, ускорили обработку заказов в 2-3 раза",
        technologies: [
          "1С:Предприятие 8.3",
          "1С",
          "механизм ролей",
